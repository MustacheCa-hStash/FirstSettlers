Shader "Custom/RedMapleBillboardTintCutout"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 treeLeafTint = _BillboardLeafTint.rgb * UNITY_ACCESS_INSTANCED_PROP(TreeBillboardInstanceProperties, _TreeLeafTint).rgb;
