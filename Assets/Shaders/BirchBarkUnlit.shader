Shader "Custom/BirchBarkSimpleLit"
{
    Properties
    {
        ...
        [HideInInspector] _FauxSideShadeStrength("Legacy Fake Side Shade Strength", Range(0, 1)) = 0.20
        _Brightness("Brightness", Range(0.25, 2)) = 1.0
        _AmbientStrength("Ambient Floor", Range(0, 1)) = 0.42
        _LightWrap("Bark Light Softness", Range(0, 1)) = 0.28
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                color.rgb = lerp(color.rgb, color.rgb * _CoolShadowColor.rgb, shadowSide * 0.10h);
