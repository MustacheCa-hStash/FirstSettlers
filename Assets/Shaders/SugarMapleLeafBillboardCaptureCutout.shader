Shader "Custom/SugarMapleLeafBillboardCaptureCutout"
{
    Properties
    {
        [MainTexture] _BaseMap("Sugar Maple Leaf Atlas / Alpha", 2D) = "white" {}
        [MainColor] _NeutralLeafColor("Neutral Capture Leaf Color", Color) = (0.9019608, 0.8862745, 0.8313726, 1.0)
        _LeafHighlightColor("Neutral Highlight Color", Color) = (0.9411765, 0.9254902, 0.8745098, 1.0)
        _LeafShadowColor("Neutral Shadow Color", Color) = (0.8039216, 0.7803922, 0.7215686, 1.0)
        _Cutoff("Alpha Clip Threshold", Range(0, 1)) = 0.42
        _LeafDetailContrast("Leaf Detail Contrast", Range(0, 1)) = 0.16
        ...
        _AmbientStrength("Ambient Strength", Range(0, 1)) = 0.72
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half highlightMask = smoothstep(0.58h, 1.0h, atlasLuma);
                ...
                half3 leafColor = lerp(_NeutralLeafColor.rgb, _LeafHighlightColor.rgb, highlightMask * 0.25h);
