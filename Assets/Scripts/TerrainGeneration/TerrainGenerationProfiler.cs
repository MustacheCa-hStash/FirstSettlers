...
public enum TerrainGenerationProfileStage
{
    ...
    FoliageCloverDraw,
    FoliageDandelionGeneration,
    FoliageDandelionBatchBuild,
    FoliageDandelionDraw,
...
public static class TerrainGenerationProfiler
{
    ...
    private static readonly string[] StageLabels =
    {
        ...
        "foliage clover draw",
        "foliage dandelion generation",
        "foliage dandelion batch build",
        "foliage dandelion draw",
